...
const DailyRewardManager = (() => {
  ...
  const REWARDS = [
    { day: 1, icon: '🎟️', label: 'Ticket x1',       reward: { type: 'ticket', count: 1 } },
    { day: 2, icon: '🌊', label: 'Shake x1',         reward: { type: 'item', itemId: 'shake', count: 1 } },
    { day: 3, icon: '🎟️', label: 'Ticket x1',       reward: { type: 'ticket', count: 1 } },
    { day: 4, icon: '🌊', label: 'Shake x1',         reward: { type: 'item', itemId: 'shake', count: 1 } },
    { day: 5, icon: '🎟️', label: 'Ticket x1',       reward: { type: 'ticket', count: 1 } },
    { day: 6, icon: '🎟️', label: 'Ticket x1',       reward: { type: 'ticket', count: 1 } },
